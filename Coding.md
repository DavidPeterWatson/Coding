...
- [Coding](#coding)
    ...
    - [4.Development Concepts/Techniques](#4development-conceptstechniques)
...
- [9.Structural Design Patterns](#9structural-design-patterns)
...
- [Uncategorised](#uncategorised)
    ...
    - [Domain Layer](#domain-layer)
        ...
        - [Domain Events (EventBus)](#domain-events-eventbus)
    ...
    - [Distributed Service Layer](#distributed-service-layer)
        ...
        - [Dynamic Web API Layer](#dynamic-web-api-layer)
    ...
    - [Presentation Layer](#presentation-layer)
        ...
        - [CSRF/XSRF Protection](#csrfxsrf-protection)
    - [Infrastructure Layer](#infrastructure-layer)
        ...
        - [EntityFramework Core Integration](#entityframework-core-integration)
        - [NHibernate Integration](#nhibernate-integration)
        - [Dapper Integration NEW](#dapper-integration-new)
- [Left Out](#left-out)
...
## 4.Development Concepts/Techniques
...
Testable Document acceptance criteria, or the definition of done for the story, which lead to test cases.Format
As a <user type>, I want <function> so that <reason>
Example: As a customer, I want to see an account list so I know the accounts I have with the bank and a summary of their status.
...
These can be easily read by developers, BAs and testers, and test scenarios can be written using them as a starting point.
